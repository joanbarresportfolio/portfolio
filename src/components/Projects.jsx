  ...
  return (
    <section className="flex flex-col items-center justify-center px-6 lg:px-20 py-16 bg-purple-600 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
        ...
        {/* Segunda fila (repetidos) */}
        <div className="bg-white rounded-lg overflow-hidden shadow-md flex items-center justify-center h-52">
          <img src={flutter} alt="Flutter Project 2" className="w-auto h-full object-contain p-6" />
        </div>
        <div className="bg-white rounded-lg overflow-hidden shadow-md flex items-center justify-center h-52">
          <img src={laravel} alt="Laravel Project 2" className="w-auto h-full object-contain p-6" />
        </div>
        <div className="bg-white rounded-lg overflow-hidden shadow-md flex items-center justify-center h-52">
          <img src={odoo} alt="Odoo Project 2" className="w-auto h-full object-contain p-6" />
        </div>
