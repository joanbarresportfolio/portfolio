      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="mb-4">
            ...
            <p className="text-sm">Worked on React, Node.js and MongoDB-based applications. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam quis deserunt eius sunt exercitationem accusantium dignissimos illum ab natus magni.</p>
          </div>
          <div>
            <p className="font-semibold">BSc in Computer Science</p>
            <p className="text-sm text-gray-600">Tech University • 2014 - 2018</p>
            <p className="text-sm">Graduated with honors in web technologies and software engineering. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum, eveniet eum blanditiis amet harum aliquam debitis. Incidunt eveniet aspernatur debitis?</p>
          </div>
        </motion.div>
