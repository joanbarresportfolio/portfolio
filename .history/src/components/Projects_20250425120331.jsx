    ...
    <section className="flex flex-col items-center justify-center px-6 lg:px-20 py-16 bg-purple-600 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-7xl">
        <div className="bg-white rounded-lg overflow-hidden shadow-md">
          <img src={flutter} alt="Flutter Project" className="w-full h-40 object-cover" />
        </div>
        <div className="bg-white rounded-lg overflow-hidden shadow-md">
          <img src={laravel} alt="Laravel Project" className="w-full h-40 object-cover" />
        </div>
        <div className="bg-white rounded-lg overflow-hidden shadow-md">
          <img src={odoo} alt="Odoo Project" className="w-full h-40 object-cover" />
        </div>
