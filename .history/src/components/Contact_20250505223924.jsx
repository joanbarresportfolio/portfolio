  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          className="w-full  border border-gray-300 bg-white text-black text-sm font-medium px-4 py-2 rounded hover:bg-gray-600 hover:text-white transition"
        >
          Send Message
        </button>
      </motion.form>
      ...
      {/* Redes sociales */}
      <motion.div
        className="flex justify-center gap-8 bg-gray-600 items-center w-full max-w-3xl"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={{
      ...
      >
        {[
          ...
          <motion.a
            ...
            className="text-gray-800 hover:text-gray-500 text-3xl md:text-4xl transition"
            variants={fadeUp}
            custom={index + 2}
          >
            {item.icon}
