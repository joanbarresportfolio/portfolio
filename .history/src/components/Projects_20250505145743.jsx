        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col gap-4">
              ...
              <a
                href={project.link}
                className="mt-4 inline-flex items-center justify-center border-4 border-gray-600 bg-white-600 text-black text-sm font-medium px-4 py-2 rounded hover:bg-gray-600 hover:text-white transition"
              >
