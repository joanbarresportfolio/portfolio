    ...
    <section className="flex flex-col items-center justify-center px-6 lg:px-20 py-16 bg-gray-100">
      <div className="text-center mb-12">
        <h1 className="text-4xl lg:text-5xl font-bold mb-4 text-black">
          How am I <span className="text-black">About me</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl w-full">
        ...
        <div className="flex flex-col items-start text-left">
          <h2 className="text-2xl font-bold text-black-600 mb-4">My Story</h2>
        ...
        <div className="flex flex-col items-start text-left">
          <h2 className="text-2xl font-bold text-black-600 mb-4">Education & Experience</h2>
        ...
        <div className="flex flex-col items-start text-left">
          <h2 className="text-2xl font-bold text-black-600 mb-4">Skills</h2>
          <p className="text-black text-base mb-2">
