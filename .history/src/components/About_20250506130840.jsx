...
import {
  SiReact, SiAngular, SiLaravel, SiPhp, SiFlutter, SiDart, SiJava,
    ...
    <section className="bg-white px-6 lg:px-20 py-16 text-gray-800">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="mb-4">
            <p className="font-semibold">Desarrollador de aplicaciones web</p>
            <p className="text-sm text-gray-600">Mahico SL • 18/04/2023 – 07/09/2023</p>
            <p className="text-sm">
              Desarrollo de aplicaciones web usando HTML, CSS, JavaScript, React y Angular. Creación de sitios responsivos y soporte técnico a usuarios.
            </p>
          </div>
          <div className="mb-4">
            <p className="font-semibold">Curso Especialización de Ciberseguridad</p>
            <p className="text-sm text-gray-600">IES Jaume II el Just • 2023 – Actualidad</p>
          </div>
          <div className="mb-4">
          ...
          <div>
            <p className="font-semibold">Bachillerato Científico</p>
            <p className="text-sm text-gray-600">Real Colegio Escuelas Pías • 2018 – 2020</p>
          </div>
        </motion.div>
