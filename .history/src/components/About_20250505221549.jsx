  ...
  return (
    <section className="bg-white px-6 lg:px-20 py-16 text-gray-800">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-6 h-full ml-16">
        ...
        {/* Tools & Technologies */}
        <div className="p-6 h-full">
          <h2 className="text-2xl font-bold mb-16 ml-10 text-center">Tools & Technologies</h2>
          <div className="grid grid-cols-3 gap-6 justify-items-center items-center text-gray-700 ml-10">
            {[ 
