...
const Projects = () => {
  return (
    <section className="bg-purple-700 text-white py-12 text-center">
      <h1 className="text-4xl font-bold mb-2">My <span className="text-white">Projects</span></h1>
      ...
      <div className="flex justify-center">
        <div className="flex gap-10 overflow-x-auto px-4 py-6 scrollbar-hide max-w-6xl w-full justify-center">
          <img
            src={logo1}
            alt="Project 1"
            className="w-72 h-72 object-contain bg-white p-2 rounded-xl shadow-lg"
          />
          <img
            src={logo2}
            alt="Project 2"
