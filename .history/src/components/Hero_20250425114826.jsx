...
const Hero = () => {
  return (
    <section className="flex flex-col-reverse lg:flex-row items-center justify-between px-6 lg:px-20 lg:m-10 py-16 bg-white ml-20 mr-20">
      {/* Text content */}
      ...
      <div className="w-full lg:w-1/2 flex justify-center mb-10 lg:mb-0">
        <div className="rounded-full border-4 border-purple-600 p-1 shadow-xl">
          <img
            src={portrait}
            alt="Joan Barres"
            className="rounded-full w-100 h-100 sm:w-56 sm:h-56 object-cover"
          />
        </div>
      </div>
    </section>
