    ...
    <section className="flex flex-col items-center justify-center px-6 lg:px-20 py-16 bg-white text-center">
      ...
      <div className="max-w-3xl">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-black leading-tight mb-6">
          Hi, I'm <span className="text-gray-900">Joan Barres</span>
        </h1>
        ...
        <a 
          href="#projects"
          className="inline-block bg-purple-600 hover:bg-purple-700 text-black font-semibold px-8 py-3 rounded-lg shadow-lg transition-all duration-300"
        >
          View Projects
        </a>
      </div>
