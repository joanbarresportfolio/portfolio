...
<div className="bg-white p-6 rounded-lg shadow-md h-full flex flex-col justify-between">
  ...
  <div className="grid grid-cols-3 gap-4 justify-items-center items-center text-gray-700">
    
    <div className="flex flex-col items-center">
      <SiReact size={24} className="text-blue-500" />
      <span className="mt-1 text-xs">React.js</span>
    </div>

    <div className="flex flex-col items-center">
      <SiNextdotjs size={24} className="text-black" />
      <span className="mt-1 text-xs">Next.js</span>
    </div>
    ...
    <div className="flex flex-col items-center">
      <SiTypescript size={24} className="text-blue-700" />
      <span className="mt-1 text-xs">TypeScript</span>
    </div>
