...
const Projects = () => {
  return (
    <section className="py-20 bg-purple-700 text-center px-6 lg:px-20 text-white">
      ...
      <button className="bg-yellow-400 hover:bg-yellow-500 text-purple-900 font-semibold px-6 py-3 rounded-xl shadow-md mb-10 transition">
        View Projects
      </button>
      ...
      <div className="flex justify-center">
        <div className="flex gap-10 overflow-x-auto px-4 py-6 scrollbar-hide max-w-5xl w-full justify-center">
          <img
            ...
            alt="Project 1"
            className="w-32 h-32 object-contain bg-white p-2 rounded-xl shadow-lg"
          />
          <img
