...
import {
  ...
  SiJavascript, SiMongodb, SiMysql, SiDocker, SiGit, SiGithub, SiFigma
} from "react-icons/si";
...
<div className="bg-white p-6 rounded-lg shadow-md h-full">
  ...
  <div className="grid grid-cols-2 gap-6 justify-items-center items-center text-gray-700">
    ...
    <div className="flex flex-col items-center">
      <SiMongodb size={32} className="text-green-700" />
    ...
    <div className="flex flex-col items-center">
      <SiGit size={32} className="text-orange-500" />
    ...
    <div className="flex flex-col items-center">
      <SiFigma size={32} className="text-pink-500" />
